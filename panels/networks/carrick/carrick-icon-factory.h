...
typedef enum {
  ...
  ICON_WIMAX_NETWORK_STRONG,
  ICON_WIMAX_NETWORK_STRONG_HOVER,
  ICON_WIMAX_NETWORK_WEAK,
  ICON_WIMAX_NETWORK_WEAK_HOVER,
  ICON_3G_NETWORK_STRONG,
  ICON_3G_NETWORK_STRONG_HOVER,
  ICON_3G_NETWORK_WEAK,
  ICON_3G_NETWORK_WEAK_HOVER
} CarrickIconState;
