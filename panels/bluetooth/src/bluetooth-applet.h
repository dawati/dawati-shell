...
/* This file is copied from gnome-bluetooth. The (private) library 
 * is installed by gnome-bluetooth but the header is not 
 * (gobject-introspection is though). We really want to use this lib
 * so copy header here, and hope we can talk gnome-bluetooth owners
 * into including it in future...
 */
