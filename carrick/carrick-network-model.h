...
enum {
  ...
  CARRICK_COLUMN_PROXY_METHOD,
  CARRICK_COLUMN_PROXY_URL,
  CARRICK_COLUMN_PROXY_SERVERS,
  CARRICK_COLUMN_PROXY_EXCLUDES,
  CARRICK_COLUMN_PROXY_CONFIGURED_METHOD,
  CARRICK_COLUMN_PROXY_CONFIGURED_URL,
  CARRICK_COLUMN_PROXY_CONFIGURED_SERVERS,
  CARRICK_COLUMN_PROXY_CONFIGURED_EXCLUDES,
};
